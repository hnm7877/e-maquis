            ...
            <div className="col">
                <div className="bg-danger rounded overflow-hidden">
                    <div className="pd-25 d-flex align-items-center">
                        ...
                        <div className="mg-l-20">
                            <p className="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Today Sales</p>
            ...
            <div className="col">
                <div className="bg-primary rounded overflow-hidden">
                    <div className="pd-25 d-flex align-items-center">
                        ...
                        <div className="mg-l-20">
                            <p className="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">% Unique Visits</p>
